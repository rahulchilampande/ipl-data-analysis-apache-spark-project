...
from pyspark.sql.types import StructField, StructType, IntegerType, StringType, BooleanType, DataType, DateType, DecimalType
from pyspark.sql.functions import when, sum, avg, row_number, col
...
# windows fucntion : calculate running total of runs in each match for each over
...
# Extracting year, month, day from match date for more detailed time-based analysis

match_df = match_df.withColumn("year", year("match_date"))
match_df = match_df.withColumn("month", month("match_date"))
match_df = match_df.withColumn("day", dayofmonth("match_date"))

# high margin Win : categorizing win margins into high, low and medium
...
# Nomalize and clean player names
...
player_matchab = spark.sql(""" select * from player_match""")
player_matchab.show(2)
